  ...
  // Counts and limit for purchase order
    ...
    function calculate_store(sl) {
      ...
      $("#total_vat_amnt").val(v.toFixed(2, 2)),
        ...
        if (purchase_edit_page == 1 ) {
            ...
            var url= base_url + "purchase/purchase/paysenz_showpaymentmodal";
            $.ajax({
                type: "post",
                url: url,
    ...
    $(document).on('click','#add_new_payment_type',function(){
      var base_url = $('#base_url').val();
      window.location.href = base_url + "add_payment_method"; // ✅ Redirects always
    });
    ...
    var options = {
        ...
        $.ajax( {
          url: base_url + "purchase/purchase/paysenz_product_search_by_supplier",
          method: 'post',
          dataType: "json",
          data: {
            term: request.term,
       ...
       select: function( event, ui ) {
          ...
          var  supplier_id=$('#supplier_id').val();
            ...
            $.ajax({
                type: "POST",
                url: base_url+"purchase/purchase/paysenz_retrieve_product_data",
      ...
      var purchasedatatable = $('#PurList').DataTable({ 
         ...
         data.csrf_test_name = csrf_test_name;
          ...
          'columns': [
             ...
             { data: 'supplier_name'},
             { data: 'purchase_date' },
             { data: 'expiry_date', class: "text-center", render: function(data) { return data ? data : "-"; } }, // ✅ New Expire Date Column
