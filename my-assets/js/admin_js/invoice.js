...
function addInputField_invoice(t) {
  ...
  if (count == limits)
    ...
    ((e.innerHTML =
      ...
      tab2 +
      "'/></td><td><select class='form-control invoice_fields' onchange='invoice_product_batch(" +
      count +
      ")' id='serial_no_" +
      count +
      ...
      count +
      "' readonly value='None' /></td><td><input type='text' name='product_quantity[]' value='1' required onkeyup='paysenz_invoice_quantity_calculate(" +
      count +
      ...
      count +
      "' class='form-control text-right' placeholder='0.00' min='0' tabindex='" +
      tab13 +
      ...
      count +
      "' value='0.00' readonly /></td><td><input type='hidden' id='all_discount_" +
      count +
...
function addInputField_invoice_dynamic(t) {
  ...
  if (count == limits)
    ...
    ((e.innerHTML =
      ...
      "' name='product_id[]' id='SchoolHiddenId'/></td><td><input type='text' name='desc[]'' class='form-control text-right ' tabindex='" +
      tab2 +
      "'/></td><td><select class='form-control basic-single'  onchange='invoice_product_batch(" +
      count +
      ")' id='serial_no_" +
      count +
...
function deleteRow_invoice(t) {
  ...
  if (1 == a) alert("There only one row you can't delete.");
    ...
    $("#normalinvoice > tbody > tr td input.common_total_price").each(
      function () {
        common_total_price++;
