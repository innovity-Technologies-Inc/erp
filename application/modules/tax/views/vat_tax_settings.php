    ...
    <div class="col-sm-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body container" >
                <label for="re1" class=" invoice-view-option">Fixed EIN
                    <input type="radio" id="re1" <?php if(!empty($vtinfo)){if($vtinfo->fixed_tax == 1){echo 'checked';}}?>  name="fixordy" value="1">
                    <span class="checkmark"></span>
                </label>
                <small ><ul>** Individual Product & service EIN.Set EIN value from product & service add (Dynamic EIN wont apply)**</ul></small>
                <label for="re2" class=" invoice-view-option">Dynamic EIN
                    <input type="radio" id="re2" <?php if(!empty($vtinfo)){if($vtinfo->dynamic_tax == 1){echo 'checked';}}?> name="fixordy" value="2">
                    <span class="checkmark"></span>
                </label>
                <small ><ul>** Global EIN for product & service. Need to add multiple taxs from EIN setting (Fixed EIN wont apply)**</ul></small>
