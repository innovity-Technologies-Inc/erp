...
class Accounts extends MX_Controller
{
  ...
  public function paysenz_payment_method_form($id = null)
  {
  ...
  public function paysenz_supplier_payment()
  {
  ...
  public function create_customer_receive()
  {
    ...
    $this->form_validation->set_rules('txtCode', 'Account Code', 'max_length[100]');
    $this->form_validation->set_rules('txtAmount', 'Amount', 'required|max_length[100]');
    if ($this->form_validation->run()) {
  ...
  public function paysenz_cash_adjustment()
  {
    $data['title']      = display('cash_adjustment');
    $data['voucher_no'] = $this->accounts_model->Cashvoucher();
    $data['module']     = "account";
