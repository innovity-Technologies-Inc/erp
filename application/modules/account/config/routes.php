...
$route['add_payment_method']   = "account/accounts/paysenz_payment_method_form";
$route['add_payment_method/(:num)']   = "account/accounts/paysenz_payment_method_form/$1";
$route['payment_method_list']   = "account/accounts/payment_method_list";
$route['supplier_payment']= "account/accounts/paysenz_supplier_payment";
...
$route['cash_adjustment'] = "account/accounts/paysenz_cash_adjustment";
