...
class Attendance extends MX_Controller {
    ...
    public function paysenz_add_attendance(){
      ...
      public function paysenz_create_atten(){
...
public function sign_out(){
   ...
   if($this->attendance_model->signout($postData)){
    ...
    public function paysenz_edit_attendance($id = null){
    ...
    function attendance_bulkupload()
    {
       ...
       public function paysenz_delete_attendance($id = null) {
       ...
       // attendance report
    public function paysenz_attendance_report() {
   ...
   public function paysenz_datewiseattendancereport() {
    $data['title']      = display('attendance_report');
