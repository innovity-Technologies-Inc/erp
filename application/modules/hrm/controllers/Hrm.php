...
class Hrm extends MX_Controller {
    ...
    public function paysenz_designation_list(){
        ...
        public function paysenz_designation_form($id = null)
    {
       ...
       public function paysenz_deletedesignation($id = null) {
     ...
     /*employee part start*/
      public function paysenz_employee_form($id = null){
   ...
   $data['employee'] = (object)$postData = [
        ...
        public function paysenz_employee_list(){
        ...
        public function paysenz_employee_profile($id){
       ...
       public function paysenz_delete_employee($id = null) {
