...
class Expense extends MX_Controller {
    ...
    public function paysenz_expense_item_list(){
        ...
        public function paysenz_expense_item_form($id = null)
    {
    ...
    public function paysenz_add_expense(){
    ...
    echo Modules::run('template/layout', $data);
        ...
        public function paysenz_create_expense(){
