...
class Service extends MX_Controller {
 ...
 public function paysenz_service_form(){
    ...
    public function paysenz_manage_service(){
    ...
    public function paysenz_edit_service($service_id) {
    ...
    function uploadCsv_service()
     {
        ...
        public function paysenz_service_invoice_form() {
        $data = array(
