...
class Permission extends MX_Controller
{
    ...
    public function paysenz_user_roleassign(){
    ...
    public function paysenz_add_role(){
    ...
    public function paysenz_role_list(){
    ...
    public function paysenz_edit_role($id){
    ...
    public function paysenz_role_delete($id){
