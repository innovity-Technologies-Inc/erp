    ...
    <div class="col-sm-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                <?php echo form_open_multipart('purchase/purchase/paysenz_save_purchase',array('class' => 'form-vertical', 'id' => 'insert_purchase','name' => 'insert_purchase'))?>
                    ...
                    <table class="table table-bordered table-hover" id="purchaseTable">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td class="text-right" colspan="8"><b><?php echo display('purchase_discount') ?>:</b>
                                </td>
                                <td class="text-right">
