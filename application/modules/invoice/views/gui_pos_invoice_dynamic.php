        ...
        <div class="tab-pane fade active in" id="home">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    <?php echo form_open_multipart('invoice/invoice/paysenz_manual_sales_insert', array('class' => 'form-vertical', 'id' => 'gui_sale_insert', 'name' => 'insert_pos_invoice')) ?>
            ...
            <div class="modal-body">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center">Add New Merchant</td>
                        ...
                        <tr>
                            <td class="text-center">Search Old Merchant</td>
