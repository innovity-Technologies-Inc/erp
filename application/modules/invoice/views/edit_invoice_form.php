...
<div class="row">
                    ...
                    <table class="table table-bordered table-hover" id="normalinvoice">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td class="text-right"><b><?php echo display('invoice_discount') ?>:</b></td>
                                <td class="text-right">
                            ...
                            <tr>
                                <td class="text-right"><b><?php echo display('total_discount') ?>:</b></td>
                                <td class="text-right">
                            ...
                            <tr>
                                <td class="text-right"><b><?php echo display('ttl_val') ?>:</b></td>
                                <td class="text-right">
                            ...
                            <tr>
                                <td colspan="11"></td>
                                <td class="text-right"><b><?php echo display('shipping_cost') ?>:</b></td>
                                <td class="text-right">
                            ...
                            <tr>
                                <td colspan="11"></td>
                                <td class="text-right"><b><?php echo display('previous'); ?>:</b></td>
                                <td class="text-right">
                            ...
                            <tr>
                                <td colspan="11"></td>
                                <td class="text-right"><b><?php echo display('net_total'); ?>:</b></td>
                                <td class="text-right">
                            ...
                            <tr>
                                <td colspan="11"></td>
                                <td class="text-right"><b><?php echo display('paid_ammount') ?>:</b></td>
                                <td class="text-right">
                            ...
                            <tr>
                                ...
                                <td class="text-right"><b><?php echo display('due') ?>:</b></td>
                                <td class="text-right">
                            ...
                            <tr>
                                <td colspan="11"></td>
                                <td class="text-right"><b><?php echo display('change') ?>:</b></td>
                                <td class="text-right">
    ...
    <script>
        $(document).ready(function() {
            // Load batch numbers for existing products on edit page load
            var rows = $("#normalinvoice tbody tr").length;
            for (var i = 1; i <= rows; i++) {
                var prod_id = $(".product_id_" + i).val();
                if (prod_id) {
                    // Load product data to populate batch dropdown
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            // Update batch dropdown with options
                            var batchHtml = obj.serial.substring(obj.serial.indexOf('<option'), obj.serial.lastIndexOf('</select>') + 0);
                            // Find and update the corresponding dropdown
                            $("select[name='serial_no[]']").each(function(index) {
                                if (index === i - 1) {
                                    $(this).html(batchHtml);
                                }
                            });
